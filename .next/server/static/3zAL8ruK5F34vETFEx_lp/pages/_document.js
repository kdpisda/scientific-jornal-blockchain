...
// EXTERNAL MODULE: external "react-native-web"
var external_react_native_web_ = __webpack_require__("F62O");
...
class _document_MyDocument extends document_default.a {
  static async getInitialProps({
    ...
    external_react_native_web_["AppRegistry"].registerComponent('Main', () => next_document["Main"]);
    const {
      getStyleElement
    } = external_react_native_web_["AppRegistry"].getApplication('Main');
    const page = renderPage();
    const styles = [external_react_default.a.createElement("style", {
      dangerouslySetInnerHTML: {
        __html: normalizeNextElements
      }
    }), getStyleElement()];
    return _objectSpread({}, page, {
      styles: external_react_default.a.Children.toArray(styles)
    });
  }
  ...
  render() {
    ...
    }, external_react_default.a.createElement(next_document["Head"], null, external_react_default.a.createElement("meta", {
      name: "viewport",
    ...
    }, external_react_default.a.createElement(next_document["Main"], null), external_react_default.a.createElement(next_document["NextScript"], null)));
  }
